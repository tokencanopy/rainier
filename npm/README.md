...
Or pin this release: `npx @tokencanopy/rainier@0.0.8 --help`.
...
The first invocation downloads the matching native v0.0.8 binary from GitHub
...
[standalone release binary](https://github.com/tokencanopy/rainier/releases/tag/v0.0.8).
...
Follow the [first-session guide](https://github.com/tokencanopy/rainier/blob/v0.0.8/docs/cli-quickstart.md)
...
Version 0.0.8 is beta: interfaces may change. npm's `beta` tag selects the beta
...
or version. Run `rainier version` to confirm `rainier v0.0.8`. There is no native CLI auto-updater.
...
Never replace v0.0.8 assets or mutate their pinned hashes after publication;
