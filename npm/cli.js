...
try {
  ...
  console.error('Check network access to GitHub and cache-directory permissions. Standalone binaries: https://github.com/tokencanopy/rainier/releases/tag/v0.0.3');
  process.exitCode = 1;
}
