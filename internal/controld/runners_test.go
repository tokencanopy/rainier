...
// ---------------------------------------------------------------------------
// generation fencing and capability negotiation moved with the plane: the
// generation mint, its two fences, the announce's capability validation, and
// the accept are runnerplane/plane_test.go's now (TestGenerationContinuesAcross
// Restart, TestSupersededConnectionIsFencedOnHeartbeat, TestEventGenerationSource,
// TestRunnerGenerationFencesAStaleSocket, TestAnnouncedCapabilities). What is
// left here is what the host still answers for: the setup and credential
// asides above, and the placement generation a create carries.
// ---------------------------------------------------------------------------
